...
load_local_env() {
  ...
  export CHAT_AGENT_SERVICE_PORT="${CHAT_AGENT_SERVICE_PORT:-3105}"
  ...
  export CHAT_AGENT_SERVICE_BASE_URL="${CHAT_AGENT_SERVICE_BASE_URL:-http://localhost:${CHAT_AGENT_SERVICE_PORT}}"
}
...
CHAT_AGENT_SERVICE_PORT=$CHAT_AGENT_SERVICE_PORT
...
CHAT_AGENT_SERVICE_BASE_URL=$CHAT_AGENT_SERVICE_BASE_URL
